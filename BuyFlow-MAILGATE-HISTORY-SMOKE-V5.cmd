...
setlocal
chcp 65001 >nul
set "BF_PS1=%TEMP%\BuyFlow-MAILGATE-HISTORY-SMOKE-V5-%RANDOM%-%RANDOM%.ps1"
set "BF_URL=https://raw.githubusercontent.com/kozmaasd0508/buyflow-v3/32052532feb1765b81a153d92d2612531accf222/scripts/run-mailgate-n8n-gmail-history-smoke-v5.ps1"

echo.
echo ============================================================
echo BUYFLOW MAILGATE - GMAIL historyId/history.list SMOKE V5
echo Egy lepes - helyes n8n profil - csak olvasas
echo ============================================================
echo.
