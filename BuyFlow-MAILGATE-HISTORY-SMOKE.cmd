...
setlocal
chcp 65001 >nul
set "BF_PS1=%TEMP%\BuyFlow-MAILGATE-HISTORY-SMOKE-%RANDOM%-%RANDOM%.ps1"
set "BF_URL=https://raw.githubusercontent.com/kozmaasd0508/buyflow-v3/efeed8886bf961cd6e31dec44e4994b3720473cf/scripts/run-mailgate-n8n-gmail-history-smoke.ps1"

echo.
echo ============================================================
echo BUYFLOW MAILGATE - GMAIL historyId/history.list SMOKE
echo Egy lepes - csak olvasas
echo ============================================================
echo.
