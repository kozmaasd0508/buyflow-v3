...
<style>
body{font-family:system-ui;background:#071020;color:#fff;max-width:1180px;margin:auto;padding:28px}.c{background:#0d1830;padding:20px;border-radius:18px;margin:14px 0}button,select{padding:11px 14px;border:0;border-radius:10px;font-weight:700}button{background:#7c4dff;color:#fff}.muted{color:#9fb0c9}.bad{color:#ff9b9b}.good{color:#8ef0ba}table{width:100%;border-collapse:collapse}th,td{text-align:left;vertical-align:top;padding:8px;border-bottom:1px solid #263551}code{white-space:pre-wrap;word-break:break-word;color:#dfe7ff}.ev{font-size:12px;color:#b8c6de}
</style>
