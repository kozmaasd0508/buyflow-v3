...
function merchantShipment(overrides: Partial<CarrierBridgeEvidence> = {}): CarrierBridgeEvidence {
  return {
    ...
    eventType: 'shipment', orderNumber: '20336215', trackingNumber: null, carrier: 'FoxPost / Packeta', parcelSender: null, confidence: 0.78, ...overrides,
  };
}
...
function carrier(overrides: Partial<CarrierBridgeEvidence> = {}): CarrierBridgeEvidence {
  return {
    ...
    eventType: 'shipment', orderNumber: null, trackingNumber: 'CLFOX178524111362058', carrier: 'FOXPOST', parcelSender: 'GATE.SHOP HU', confidence: 0.9, ...overrides,
  };
}
