...
test('Marketa packing requires trusted sender and explicit future courier handoff', () => {
  ...
  assert.equal(parseDeterministicLifecycleEmail({
    senderDomains: ['marketa.hu.attacker.com'],
    subject,
    bodyText: `${body} Várhatóan raktárunk 1-2 munkanapon belül átadja azt a futárszolgálatnak.`,
  }), null);
});
