...
$distro = "Ubuntu-24.04"
$runner = Join-Path $here "v12-student-mine-candidates-v1.py"

Write-Host ""
Write-Host "==============================================================" -ForegroundColor Cyan
Write-Host "BUYFLOW V12 - STUDENT HARD-CASE MINE V1" -ForegroundColor Cyan
Write-Host "144 uj synthetic hard case | teacher elotti disagreement mining" -ForegroundColor Cyan
Write-Host "==============================================================" -ForegroundColor Cyan
Write-Host ""
Write-Host "Ez NEM tanit es NEM hiv kulso teacher API-t." -ForegroundColor Green
Write-Host "Uj synthetic/deidentified eseteket futtat a V11 student + constrained outputtal." -ForegroundColor Green
Write-Host "A vegen csak a disagreementek + kis agreement audit kerul teacher queue-ba." -ForegroundColor Gray
Write-Host ""
...
if ($LASTEXITCODE -ne 0) { throw "V12_STUDENT_MINE_FAILED" }
