...
replacements = [
    ...
    ('EXPECTED_TRAIN_SHA = "50fb0d02df0e27c02c52763b4740614c354de02896df5494df0b42c1acbeb2bf"', 'EXPECTED_TRAIN_SHA = "5c8c2b188d92088186aaf9d7bef4c60a7c997fe304e328cdcdac2275afbda382"'),
    ('EXPECTED_VAL_SHA = "3586eeab32c1d769f471f6604037350b0daafb88d5df66b716595794fbe2f56c"', 'EXPECTED_VAL_SHA = "95a2f04f1b22cfc4592ba82726a23895fa492d6df6a0514cd040dac8ac188c0e"'),
    ...
    ('External Blind V2: UNTOUCHED', 'Closed Blind V4: NOT READ DURING TRAINING'),
...
# Add a non-promotional warning if internal synthetic validation worsens.
