...
$distro = "Ubuntu-24.04"
$runner = Join-Path $here "v12-retention-compare-v1.py"

Write-Host ""
Write-Host "==============================================================" -ForegroundColor Cyan
Write-Host "BUYFLOW V12 - ALL 18 LABEL RETENTION COMPARE" -ForegroundColor Cyan
Write-Host "288 V11 replay validation | V11 vs V12 | constrained output" -ForegroundColor Cyan
Write-Host "==============================================================" -ForegroundColor Cyan
Write-Host ""
Write-Host "Ez NEM tanit es NEM modositja a corpust." -ForegroundColor Green
Write-Host "Csak a 288 V11_REPLAY_VALIDATION sort meri meg, mind a 18 labelbol 16-ot." -ForegroundColor Green
Write-Host "Fresh Blind / Input View Holdout / frozen108 / BLIND50 nincs olvasva." -ForegroundColor Gray
Write-Host "Ez fejlesztesi retention-meres, nem uj untouched holdout." -ForegroundColor Gray
Write-Host ""
...
if ($LASTEXITCODE -ne 0) { throw "V12_RETENTION_COMPARE_FAILED" }

Write-Host ""
Write-Host "Kesz. Kuldd el a # SUMMARY + # BY_EVENT + ket WRONG_TRANSITIONS reszt." -ForegroundColor Cyan
