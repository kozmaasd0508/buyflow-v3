...
$distro = "Ubuntu-24.04"
$runner = Join-Path $here "v11-input-view-addback-v1.py"

Write-Host ""
Write-Host "==============================================================" -ForegroundColor Cyan
Write-Host "BUYFLOW V11 - INPUT VIEW ADD-BACK V1" -ForegroundColor Cyan
Write-Host "FULL-only nyeresek: melyik kihagyott adat szamit?" -ForegroundColor Cyan
Write-Host "==============================================================" -ForegroundColor Cyan
Write-Host ""
Write-Host "Ez diagnosztika, NEM tanit es NEM modosit holdoutot." -ForegroundColor Green
Write-Host "Csak a FULL-helyes / SEMANTIC-hibas eseteken fut nehany kis add-back probat." -ForegroundColor Green
Write-Host ""
...
if ($LASTEXITCODE -ne 0) { throw "V11_INPUT_VIEW_ADDBACK_FAILED" }
