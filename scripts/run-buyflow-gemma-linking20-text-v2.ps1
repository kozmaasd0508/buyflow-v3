...
$commit = '9d89e884d516a1f6fe62d6ee2a71da503309cb29'
...
$test = Join-Path $env:TEMP 'test-buyflow-gemma-chat-linking20-text-v2.mjs'
$url = "https://raw.githubusercontent.com/kozmaasd0508/buyflow-v3/$commit/scripts/test-buyflow-gemma-chat-linking20-text-v2.mjs"
