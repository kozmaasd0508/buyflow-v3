...
$runnerCommit='0d405bd189b2a924cf63f43154ef4bedfdb201b1'
$runnerUrl="https://raw.githubusercontent.com/kozmaasd0508/buyflow-v3/$runnerCommit/apps/api/src/scripts/buyflow-real100-h2-maillens-v2-luna.ts"
...
$tempRoot=Join-Path $env:TEMP ('buyflow-h2-maillens-v2-luna-' + [guid]::NewGuid().ToString('N'))
...
try {
  ...
  Write-Host 'BUYFLOW - SAME REAL100 H2 / MAILLENS v2 + GPT-5.6 LUNA' -ForegroundColor Cyan
  ...
  Write-Host '[2/5] Prepare exact MailLens v2 runner...' -ForegroundColor Yellow
  $runnerPath=Join-Path $worktree 'apps\api\src\scripts\__buyflow-real100-h2-maillens-v2-luna-temp.ts'
