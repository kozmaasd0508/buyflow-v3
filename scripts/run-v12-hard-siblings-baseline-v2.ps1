...
$distro = "Ubuntu-24.04"
$runner = Join-Path $here "v12-hard-siblings-baseline-v2.py"

Write-Host ""
Write-Host "==============================================================" -ForegroundColor Cyan
Write-Host "BUYFLOW V12 - HARD SIBLINGS V2 / V11 BASELINE" -ForegroundColor Cyan
Write-Host "72 validation sibling | unchanged V11 + constrained output" -ForegroundColor Cyan
Write-Host "==============================================================" -ForegroundColor Cyan
Write-Host ""
Write-Host "Ez NEM tanit es NEM modositja a corpust." -ForegroundColor Green
Write-Host "A 72 validation-only siblingen meri meg a V11 jelenlegi tudását." -ForegroundColor Green
Write-Host "Frozen holdoutot nem olvas." -ForegroundColor Gray
Write-Host ""
...
if ($LASTEXITCODE -ne 0) { throw "V12_HARD_SIBLINGS_BASELINE_FAILED" }
