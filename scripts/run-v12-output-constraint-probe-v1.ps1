...
Write-Host "BUYFLOW V12 - OUTPUT CONSTRAINT PROBE V1" -ForegroundColor Cyan
Write-Host "A V11 6 invalid kimenete -> kenyszeritett 18 ervenyes cimke" -ForegroundColor Cyan
Write-Host "==============================================================" -ForegroundColor Cyan
Write-Host ""
Write-Host "Ez NEM tanit. A V11 adapterhez es a frozen holdouthoz nem nyul." -ForegroundColor Green
Write-Host "Elsore csak a FULL nezettel invalid eseteket futtatja ujra." -ForegroundColor Green
Write-Host "Cel: kideriteni, eltuntetheto-e a hibas JSON a modell ujratanitasa nelkul." -ForegroundColor Gray
Write-Host ""
...
if ($LASTEXITCODE -ne 0) { throw "V12_OUTPUT_CONSTRAINT_PROBE_FAILED" }
