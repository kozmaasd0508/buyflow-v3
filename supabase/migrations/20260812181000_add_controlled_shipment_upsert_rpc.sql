...
begin
  ...
  insert into public.shipments (
    ...
    p_source_email_id,
    jsonb_build_object(
      'controlled_resolution', true,
      'resolution_confidence', p_confidence,
      'evidence_count', v_source_count
    )
  )
  ...
  do update set
    ...
    source_email_id = coalesce(public.shipments.source_email_id, excluded.source_email_id),
    metadata = public.shipments.metadata || excluded.metadata
